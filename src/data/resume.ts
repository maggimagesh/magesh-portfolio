...
export const resume: Resume = {
  personal: {
    ...
    resumePdf:
      "https://drive.google.com/file/d/1EG-T0Upmfp7kEgQruc4BA58zMDt6c_ID/view?usp=sharing",
    avatar: "/logos/me.png",
  },
  profile:
  ...
  experience: [
    ...
    },
    {
      ...
      summary:
        "QA Team Lead, owning the test strategy and automation across multiple internal and customer-facing applications using Playwright (TypeScript) and API tools; driving quality outcomes, mentoring, cross-team coordination and on-time delivery.",
      highlights: [
    ...
    },
    {
      ...
      summary:
        "Worked on automation and manual testing across banking and e-commerce projects using Java, Selenium, Cucumber, TestNG and Postman. Built CI/CD with Jenkins and Maven, implemented data-driven tests and regression suites, and authored detailed test documentation.",
      highlights: [
  ...
  projects: [
    {
      ...
      status: "Live",
      description:
        "Career Spider helps discover and track roles with AI-assisted search and filtering.",
    ...
    },
    {
      ...
      description:
        "Angaadi is a demo e‑commerce website built for automation testers to practice and refine their testing skills. Inspired by real-world online store workflows, it includes features like product listings, advanced search, shopping cart management, checkout processes, and order tracking. Designed from tester feedback, it provides realistic scenarios for validating UI interactions, backend processes, and API calls. The platform is regularly updated to reflect modern e‑commerce challenges, making it ideal for end‑to‑end automation practice with tools such as Playwright, Selenium, and Cypress.",
